 ...
 * \param DriverObject
 * \param RegistryPath
 * \return STATUS_SUCCESS if the driver initialized correctly, otherwise an error indicating the reason for failure.
 */
...
/**
 * \brief This routine is the dispatch handler for the driver. It is responsible
 for processing the IRPs.
 * \param pDO Pointer to device object.
 * \param pIrp Pointer to the current IRP.
 * \return STATUS_SUCCESS if the IRP was processed successfully, otherwise an error
...
NTSTATUS WriteMsr(void* lpInBuffer,
                  ULONG nInBufferSize,
                  void* lpOutBuffer,
                  ULONG nOutBufferSize,
                  ULONG* lpBytesReturned) {
...
NTSTATUS ReadPmc(void* lpInBuffer,
                 ULONG nInBufferSize,
                 void* lpOutBuffer,
                 ULONG nOutBufferSize,
                 ULONG* lpBytesReturned) {
...
NTSTATUS ReadIoPort(ULONG ioControlCode,
                    void* lpInBuffer,
                    ULONG nInBufferSize,
                    void* lpOutBuffer,
                    ULONG nOutBufferSize,
...
NTSTATUS WriteIoPort(ULONG ioControlCode,
                     void* lpInBuffer,
                     ULONG nInBufferSize,
                     void* lpOutBuffer,
                     ULONG nOutBufferSize,
...
NTSTATUS ReadPciConfig(void* lpInBuffer,
                       ULONG nInBufferSize,
                       void* lpOutBuffer,
                       ULONG nOutBufferSize,
                       ULONG* lpBytesReturned) {
...
NTSTATUS WritePciConfig(void* lpInBuffer,
                        ULONG nInBufferSize,
                        void* lpOutBuffer,
                        ULONG nOutBufferSize,
                        ULONG* lpBytesReturned)
...
NTSTATUS ReadMemory(void* lpInBuffer,
                    ULONG nInBufferSize,
                    void* lpOutBuffer,
                    ULONG nOutBufferSize,
                    ULONG* lpBytesReturned) {
...
NTSTATUS WriteMemory(void* lpInBuffer,
                     ULONG nInBufferSize,
                     void* lpOutBuffer,
                     ULONG nOutBufferSize,
                     ULONG* lpBytesReturned) {
